<div class="col-md-12">
    <div class="panel panel-success">
        <div class="panel-heading" style="padding-bottom: 40px;">
            <center><h3>CRIMINAL RECORDS MANAGEMENT SYSTEM</h3></center>
            ...
            <div class="col-md-3">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title"> 
                            <a href="user.php">
                                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> View Staff
                            </a>
                        </h3>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title"> 
                            <a href="caseview.php">
                                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> View Cases
                            </a>
                        </h3>
                    </div>
                </div>
