                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="occ" class="form-control" id="nid" placeholder="Enter Occupation" autofocus=""  >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required="" onchange="print_state('state',this.selectedIndex);" id="country_id" name ="region"></select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
